...
function(target_reflect target apiDef)
    ...
    foreach(src ${sources})
        if(src MATCHES \\.\(${allowed_file_extensions}\)$ AND NOT src MATCHES ${excluded_file_patterns})
            ...
            add_custom_command(
                ...
                COMMAND ${ROOT_BINARY_DIR}/bin/$<CONFIG>/Reflector "${CMAKE_CURRENT_SOURCE_DIR}" "${src}" "${gen_cpp}" ${apiDef} ${target}
	...
	COMMAND ${ROOT_BINARY_DIR}/bin/$<CONFIG>/Reflector "${CMAKE_CURRENT_SOURCE_DIR}" "__global__" "${gen_dir_cpp}/__global__.cpp" ${apiDef} ${target}
